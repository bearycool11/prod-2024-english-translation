...
<template>
  <section class="bg-gray-50 dark:bg-gray-900">
    <div v-if="store.auth.isLoading" role="status" class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
    ...
    <div v-if="!store.auth.isLoading" class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a
        href="#"
