<template>
  ...
  <aside
    v-if="name"
    id="default-sidebar"
    class="top-0 left-0 z-40 shrink min-w-64 max-w-64 min-h-screen transition-transform md:static fixed md:translate-x-0 pt-12"
    :class="{
      '-translate-x-full': !store.ui.isSideBarOpen,
      'translate-x-0 h-screen': store.ui.isSideBarOpen
    }"
    aria-label="Sidebar"
  >
    <div
      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">История постов</span>
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ms-3 whitespace-nowrap">Экстренные функции</span>
          </router-link>
        </li>
      </ul>
